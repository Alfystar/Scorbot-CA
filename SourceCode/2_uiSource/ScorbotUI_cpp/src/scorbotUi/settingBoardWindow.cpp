...
void SettingBoardWindow::updateSetting() {
    if (ui->in1V1->isChecked())
        ...
        double volt = QInputDialog::getDouble(this, "Voltage Trim Reference", "External Voltage Reference:");
    }
...
void SettingBoardWindow::scorParamReset_handler() {
    ...
    setting->setMotorLimit(Mot1, 2160, 24300, 4168);
    setting->setMotorLimit(Mot2, 2960, 16200, 1040);
    setting->setMotorLimit(Mot3, 2960, 21900, 4168);
    setting->setMotorLimit(Mot4, 2160, 10000, 4168);
    setting->setMotorLimit(Mot5, 2400, 10000, 4168);
    setting->setMotorLimit(Mot6, 2160, 5770, 208);
