...
class MyUiQt (Ui_UiClass):
    ...
    def encoderValue(self):
       ...
       #funzione compoini messaggio che manda la lista dei valori degli encoder a Francesco
        ...
        invia(self.encoder,"e")

      
#va messo nel main
       global mex
        self.passi1_direct.setText(str(mex[0]))
        self.passi1_2_direct.setText(str(mex[1]))
        self.passi1_3_direct.setText(str(mex[2]))
        self.passi1_4_direct.setText(str(mex[3]))
        self.passi1_5_direct.setText(str(mex[4]))
        self.passi1_6_direct.setText(str(mex[5]))
