...
struct QwtMml {
    ...
    enum ColAlign {
        ColAlignLeft, ColAlignCenter, ColAlignRight
    };
    enum RowAlign {
        RowAlignTop, RowAlignCenter, RowAlignBottom,
        RowAlignAxis, RowAlignBaseline
    };
    enum FrameType {
        FrameNone, FrameSolid, FrameDashed
    };
...
struct QwtMmlOperSpec {
    enum StretchDir {
        NoStretch, HStretch, VStretch, HVStretch
    };
...
public:
    ...
    int baseFontPointSize() const { return m_base_font_point_size; }

    void setBaseFontPointSize(int size) { m_base_font_point_size = size; }
...
protected:
    ...
    virtual QRect symbolRect() const { return QRect(0, 0, 0, 0); }
...
static const char *g_oper_spec_names[g_oper_spec_rows] = {"accent", "fence", "largeop", "lspace", "minsize",
...
static const QwtMmlOperSpec g_oper_spec_defaults =
        {0, QwtMml::InfixForm,
         {"false", "false", "false", "thickmathspace", "1", "false", "thickmathspace", "false", "false"},
         QwtMmlOperSpec::NoStretch};
...
struct OperSpecSearchResult {
    ...
    bool haveForm(QwtMml::FormType f) { return getForm(f) != 0; }
