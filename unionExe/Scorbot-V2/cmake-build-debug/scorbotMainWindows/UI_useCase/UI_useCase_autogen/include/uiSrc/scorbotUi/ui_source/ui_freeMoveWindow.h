...
public:
    ...
    void setupUi(QDialog *FreeMoveWindow)
    {
        ...
        FreeMoveWindow->resize(268, 268);
        FreeMoveWindow->setMinimumSize(QSize(268, 268));
        FreeMoveWindow->setMaximumSize(QSize(268, 268));
        ...
        layoutWidget1 = new QWidget(FreeMoveWindow);
        layoutWidget1->setObjectName(QString::fromUtf8("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(171, 10, 91, 251));
        ...
        pwmSpeed = new QSlider(layoutWidget1);
